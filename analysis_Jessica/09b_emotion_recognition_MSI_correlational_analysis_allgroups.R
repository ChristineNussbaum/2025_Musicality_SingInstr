##########################################################################
## File: 09b_emotion_recognition_MSI_correlational_analysis_allgroups.R
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/allgroups_C_Correlations_ACC_MSI.txt")
...
# save the dataset
capture.output(as.matrix(Cor_RT), file="output/emotion_classification/allgroups_C_Correlations_RT_MSI.txt")
...
title = paste0("Correlation between Emotion Classification Performance and Gold-MSI (N = 166)")

filename = paste0("plots/allgroups_05_correlations_ACC_MSI.png")
...
#-----------------------------------------------------------------------------------------------------------------#
#                            Correlations split for professionals, non-musicians and amateurs                                #
#-----------------------------------------------------------------------------------------------------------------#
...
Correlations_ACC <- rcorr(as.matrix(M[,c(6, 3:5,7:12)]), type="spearman") # auch spannend
...
# -> there is just one significant results and it does not survive correction
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/allgroups_C_Correlations_ACC_MSI_Pro_only.txt")
...
MSI <- M[, c(1,2,7:12)] %>% pivot_longer(cols = ME_mean:Mean_singing, names_to = "Test", values_to = "Score")
...
Data$Group <- factor(Data$Group, levels = c("M", "C","A"))
...
title = paste0("Correlation between Emotion Classification Performance and Gold-MSI, Professionals only (N = 40)")

filename = paste0("plots/allgroups_05b_correlations_ACC_MSI_Pro_only.png")
...
Correlations_ACC <- rcorr(as.matrix(C[,c(6, 3:5,7:12)]), type="spearman")
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/allgroups_C_Correlations_ACC_MSI_Con_only.txt")
...
MSI <- C[, c(1,2,7:12)] %>% pivot_longer(cols = ME_mean:Mean_singing, names_to = "Test", values_to = "Score")
...
title = paste0("Correlation between Emotion Classification Performance and Gold-MSI, Non-Musicians only (N = 38)")

filename = paste0("plots/allgroups_05c_correlations_ACC_MSI_Con_only.png")
...
Correlations_ACC <- rcorr(as.matrix(A[,c(6, 3:5,7:12)]), type="spearman")
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/allgroups_C_Correlations_ACC_MSI_Ama_only.txt")
...
MSI <- A[, c(1,2,7:12)] %>% pivot_longer(cols = ME_mean:Mean_singing, names_to = "Test", values_to = "Score")
...
title = paste0("Correlation between Emotion Classification Performance and Gold-MSI, Amateurs only (N = 88)")

filename = paste0("plots/allgroups_05a_correlations_ACC_MSI_Ama_only.png")
...
rm(A, Data, p, Correlations_ACC, Cor)
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/allgroups_C_Correlations_ACC_MSI_c-Education.txt")
...
# save the dataset
capture.output(as.matrix(Log), file="output/emotion_classification/allgroups_C_LogisticReg_ACC_MSI.txt")
...
# save the dataset
capture.output(as.matrix(Log), file="output/emotion_classification/allgroups_C_LogisticReg_ACC_MSI_c-Education.txt")
