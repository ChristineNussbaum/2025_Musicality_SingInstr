##########################################################################
## File: 01b_data_preparation_survey_JS.R
...
#this will be needed, I will show you. 
new <- survey %>% filter(!(Code %in% c(
  "NNW04N","AMH41E","EBJ13A","OEB92I","AIG27E","ELE07E","EGL27L","ANG04N",
  "EHZ25O","AHG16O","AYO14U","AOE84U","LFB01U","NOJ82A","ARM39A","IHP42U",
  "UEB14H","OYD07A","OLB40I","AIG12H","EVA48E","LOQ82N","AYB11N","IGC42N",
  "HRH51E","INB55E","ERE12E","EHH65E","ORH97L","EEH64N","AIL01U","AHJ75H",
  "AOP41H","ERG87A", "LSL52N","ARM79O","ILA81N","TTK72A","HÃ„M22T",
  "HBG40U","ABJ27I","AAV53H","INF69I","EUW55Y","OCS76A","UEA04N","EHW05E",
  "ATT50O","ANB29R","AEJ35H","LLS53L","ULH11I","AKG74N","ONB71U","EHM92A",
  "UUE82A","NSW88R","ECC11E","AEB91O","OTM82N","AHH44E","ARB73L","SCS58E",
  "LNE81A","UHG71H","EHA94A","IEQ58E","EAL53R","AEM51L","RRL16O","ANJ18A",
  "RIB02E","AHL00A","IBD57N","UOR66R","ATM22I","HGE17N","ADM21N","MBG42L",
  "TUG73N","NSD53O","OOD18E","OPM21I","EHK66U","NIR46E","AAZ24E","ILE70O",
  "AEB56L","OEP83I","NIZ90E","YFL29A","AHK45M")))  
...
survey$Instrument2[survey$Instrument2 == "Gesang, BlockflÃ¶te, Saxophon"] <- "Gesang"
...
survey$Instrument2[survey$Instrument2 == "Trompete (Gesang fast gleichermaÃŸen)"] <- "Trompete"
...
survey2 <- survey[,c(4,46,1,9,5,6:8,16:18,20,47,22:28,29:33,34:38,44,48:51,2,63,64,65:67,68)]

save(survey2, file="input/amateurs_survey_processed.RData")
