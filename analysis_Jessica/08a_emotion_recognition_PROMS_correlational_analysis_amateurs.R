##########################################################################
## File: 08a_emotion_recognition_PROMS_correlational_analysis_amateurs.R
...
# save the output
capture.output(as.matrix(Cor_RT), file="output/emotion_classification/amateurs_C_Correlations_RT_PROMS.txt")
...
# save the dataset
capture.output(as.matrix(Cor_r), as.matrix(Cor_p), Cor_n, file="output/emotion_classification/amateurs_C_Correlations_ACC_VER_within.txt")
...
# save the dataset
capture.output(as.matrix(Cor_r), as.matrix(Cor_p), Cor_n, file="output/emotion_classification/amateurs_C_Correlations_ACC_PROMS_within.txt")
...
Correlations_ACC <- rcorr(as.matrix(S[,c(6, 3:5, 11, 7:10)]), type="spearman")
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/amateurs_C_Correlations_ACC_PROMS_Singers_only.txt")
...
PROMS <- S[, c(1,2,7:11)] %>% pivot_longer(cols = melody:PROMS_mean, names_to = "Test", values_to = "confidence")
...
title = paste0("Correlation between Emotion Classification Performance and Music Perception Abilities, Singers only (N = 45)")

filename = paste0("plots/amateurs_04b_correlations_ACC_PROMS_Singers_only.png")
...
Correlations_ACC <- rcorr(as.matrix(I[,c(6, 3:5, 11, 7:10)]), type="spearman")
...
# save the dataset
capture.output(as.matrix(Cor), file="output/emotion_classification/amateurs_C_Correlations_ACC_PROMS_Instrumentalists_only.txt")
...
PROMS <- I[, c(1,2,7:11)] %>% pivot_longer(cols = melody:PROMS_mean, names_to = "Test", values_to = "confidence")
...
title = paste0("Correlation between Emotion Classification Performance and Music Perception Abilities, Instrumentalists only (N = 43)")

filename = paste0("plots/amateurs_04c_correlations_ACC_PROMS_Instrumentalists_only.png")
...
# save the dataset
capture.output(as.matrix(Log), file="output/emotion_classification/amateurs_C_LogisticReg_ACC_PROMS.txt")
...
# save the dataset
capture.output(as.matrix(Log), file="output/emotion_classification/amateurs_C_LogisticReg_ACC_PROMS_c-Education.txt")
